...
import { useUpdated2, setUnupdated } from '../contexts/Updated2';
    ...
    function handleSubmit(submitProps: SubmitProps)
    {
        ...
        if(updateScreen)
        {
            ...
            if(back)
            {
                ...
                {
                    //setUpdated({ song });
                    //setUpdated2({ ...updated2, homeScreen: true });
                    setUnupdated(updatedCtx, [song]);
